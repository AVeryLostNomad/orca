...
describe('electron-builder markdown file associations', () => {
  it('registers every supported text extension as an editor Open With entry', () => {
    const associations = electronBuilderConfig.fileAssociations

    expect(associations.map((association) => association.ext).sort()).toEqual(
      [...openWithFileExtensions].sort()
    )
