...
describe('computer-use e2e workflow', () => {
  ...
  it('runs macOS helper coverage without hosted TCC e2e and gates fork schedules', () => {
    const workflow = parse(
      readFileSync(join(projectDir, '.github/workflows/computer-e2e.yml'), 'utf8')
    )
    ...
    expect(job.if).toBe("github.event_name != 'schedule' || github.repository == 'stablyai/orca'")
