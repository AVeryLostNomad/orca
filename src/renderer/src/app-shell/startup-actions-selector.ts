...
export function selectStartupActions(state: StartupActions): StartupActions {
  if (
    ...
    cachedStartupActions.hydrateDataStudioSession === state.hydrateDataStudioSession &&
  ...
  cachedStartupActions = {
    ...
    hydrateDataStudioSession: state.hydrateDataStudioSession,
