...
import {
  ...
  moveRuntimeGitChangesToWorktree as moveRuntimeGitChangesToWorktreeImplementation,
...
export const moveRuntimeGitChangesToWorktree = moveRuntimeGitChangesToWorktreeImplementation
