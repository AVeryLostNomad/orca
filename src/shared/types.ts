...
export type AppMemory = UsageValues & {
  ...
  other: UsageValues
  /** Embedded VS Code (code-server) subtree. One shared refcounted process for all
   *  VS Code tabs, so it's tracked once here instead of per-worktree; zero when none open. */
  editor: UsageValues
