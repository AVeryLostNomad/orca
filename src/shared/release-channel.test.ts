...
describe('release channel', () => {
  ...
  it('keeps dev builds out of the main release repo, and apart from each other', () => {
    ...
    expect(getReleaseRepoForChannel('stable')).toBe('AVeryLostNomad/orca')
    expect(getReleaseRepoForChannel('rc')).toBe('AVeryLostNomad/orca')
  })
  ...
  it('builds release-notes links against the repo that published the version', () => {
    ...
    expect(getReleaseNotesUrlForVersion('1.4.160')).toBe(
      'https://github.com/AVeryLostNomad/orca/releases/tag/v1.4.160'
    )
    expect(getReleaseNotesUrlForVersion('v1.4.160-rc.3')).toBe(
      'https://github.com/AVeryLostNomad/orca/releases/tag/v1.4.160-rc.3'
    )
    ...
    expect(getReleaseNotesUrlForVersion(null)).toBe('https://github.com/AVeryLostNomad/orca/releases')
  })
