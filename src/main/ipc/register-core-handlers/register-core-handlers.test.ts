...
const {
  ...
  registerEditorThemeHandlersMock,
  ...
  registerEditorThemeHandlersMock: vi.fn(),
...
vi.mock('../editor-themes', () => ({
  registerEditorThemeHandlers: registerEditorThemeHandlersMock
}))
...
describe('registerCoreHandlers', () => {
  beforeEach(() => {
    ...
    registerCodeServerHandlersMock.mockReset()
    registerDataStudioHandlersMock.mockReset()
    registerEditorThemeHandlersMock.mockReset()
  ...
  it('passes the store through to handler registrars that need it', async () => {
    ...
    expect(registerCodeServerHandlersMock).toHaveBeenCalledWith({
      getKeybindings: expect.any(Function)
    })
    expect(registerDataStudioHandlersMock).toHaveBeenCalledOnce()
    expect(registerEditorThemeHandlersMock).toHaveBeenCalledOnce()
    expect(registerLspHandlersMock).toHaveBeenCalledOnce()
