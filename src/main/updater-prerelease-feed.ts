...
export const RELEASES_LATEST_DOWNLOAD_URL = `https://github.com/${MAIN_RELEASE_REPO}/releases/latest/download`
...
const TAG_HREF_RE = new RegExp(
  `href="https://github\\.com/${MAIN_RELEASE_REPO}/releases/tag/([^"]+)"`,
  'g'
)
