...
export const appApi = {
  ...
  getScratchFileDirectory: (): Promise<string> => ipcRenderer.invoke('app:getScratchFileDirectory'),
  ...
  ensureWorkspaceNotesFile: (args: Parameters<PreloadApi['app']['ensureWorkspaceNotesFile']>[0]) =>
