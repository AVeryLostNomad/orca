...
export function registerGitHandlers(
  ...
  dispatcher.onRequest('git.moveChanges', (p) => handlers.changes.moveChanges(p))
  dispatcher.onRequest('git.stashList', (p) => handlers.stash.stashList(p))
  dispatcher.onRequest('git.stashFiles', (p) => handlers.stash.stashFiles(p))
  dispatcher.onRequest('git.stashPush', (p) => handlers.stash.stashPush(p))
  dispatcher.onRequest('git.stashApply', (p) => handlers.stash.stashApply(p))
  dispatcher.onRequest('git.stashDrop', (p) => handlers.stash.stashDrop(p))
